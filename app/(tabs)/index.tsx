// app/screens/home/HomeScreen.tsx (or wherever this file lives)
      ...
      <RNScroll contentContainerStyle={styles.container}>
          ...
          >
            <View style={styles.bannerLeft}>
              ...
              <View style={{ marginLeft: 10 }}>
                ...
                <Text style={styles.bannerHeaderWhite}>
                  You're on track to exceed monthly targets by 8%!
                </Text>
              </View>
            </View>
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={styles.targetsList}>
            ...
            <ProgressBar
              label="V2 Coverage"
              dotColor={COLORS.ai.purple500}
              current={68}
              total={78}
            />
            <ProgressBar
              label="V2 Frequency Coverage"
              dotColor={COLORS.blue[600]}
              current={52}
              total={60}
            />
        ...
        <View style={styles.sectionCard}>
          ...
          <View style={{ marginTop: 12, gap: 10 }}>
            {[
              {
                name: 'Dr. Sharma',
                desc: 'Finalize order for Product X',
                place: 'Breach Candy Hospital',
                tint: '#FEE2E2',
              ...
              {
                name: 'Dr. Gupta',
                desc: 'Sample delivery and feedback',
              ...
              {
                name: 'Dr. Singh',
                desc: 'Share Medical Literature',
                place: 'Grant Road Clinic',
                tint: '#FFFAEB',
                badge: '1 days overdue',
                badgeColor: COLORS.yellow[600],
              },
              {
                name: 'Dr. Verma',
                desc: 'Share Competing Molecule info',
                place: 'Lilavati Hospital',
                tint: '#FFFAEB',
          ...
          <View style={{ marginTop: 12, gap: 10 }}>
              ...
              <View style={styles.productLeft}>
                ...
                <View  style={{ marginLeft: 12 }}>
                  ...
                  <Text style={styles.productMeta}>
                    Extended release formulation now available
                  </Text>
            ...
            >
              <View style={styles.productLeft}>
                ...
                <View style={{ marginLeft: 12 }}>
                  <Text style={styles.productTitle}>
                    DiabetCare - Stock Alert{' '}
                    <Text style={styles.productPillAlert}>Stock Alert</Text>
                  </Text>
                  <Text style={styles.productMeta}>
                    Limited stock remaining. Order soon.
                  </Text>
            ...
            >
              <View style={styles.productLeft}>
                ...
                <View style={{ marginLeft: 12 }}>
                  <Text style={styles.productTitle}>
                    Product Training: ImmunoBoost{' '}
                    <Text style={styles.productPill}>Training</Text>
                  </Text>
                  <Text style={styles.productMeta}>
                    Mandatory online session on Jan 15
                  </Text>
        ...
        <View style={styles.quickGrid}>
          ...
          <TouchableOpacity style={styles.quickActionItem} onPress={() => router.push('/screens/field-activities/sampleTracking')}>
            <View
              style={[
                styles.quickActionIconCircle,
                { backgroundColor: COLORS.ai.purple500 },
              ]}
            >
              <IconBox size={18} color={COLORS.utility.white} />
            </View>
          ...
          <View style={styles.topPerformerBanner}>
            <View style={styles.topPerformerLeft}>
              ...
              <View style={{ marginLeft: 12 }}>
                ...
                <Text style={styles.topPerformerSubtitle}>
